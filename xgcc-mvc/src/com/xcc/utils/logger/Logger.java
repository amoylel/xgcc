/**
 * Created the com.xsy.logger.XLog.java
 * @created 2016年9月20日 上午11:06:45
 * @version 1.0.0
 */
package com.xcc.utils.logger;
...
public class Logger {
	...
	private static void init() {
		...
		setFileHandlerPattern(getDefaultLogDir() + "/xcc-all-%g.%u.log");
		Logger.reloadProperties();
	}
	...
	public static void finest(String message) {
		StackTraceElement element = Logger.getStackTraceElement(new Throwable());
		String fullMessage = Logger.getFullMessageByElement(element, message);
